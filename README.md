...
export const NAV_LINKS = [
  ...
  { href: '/', key: 'how_Faith Travels_work', label: 'How Faith Travels Work?' },
...
export const FEATURES = [
  ...
  },
  {
    ...
    variant: 'green',
    description:
      "Schedule an adventure with friends. On holidays, there are many interesting offers from Faith Travels. That way, there's no more discussion",
  },
  {
...
export const FOOTER_LINKS = [
  ...
  {
    title: 'Our Community',
    links: ['Climbing xixixi', 'Hiking Faith Travels', 'Faith Travels kinthill'],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: 'Email Officer', value: 'Faith Travels@akinthil.com' },
  ],
};
